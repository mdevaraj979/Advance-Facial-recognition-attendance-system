...
class Attendance:
    def __init__(self,root):
       ...
       self.atten_status = ttk.Combobox(left_inside_frame,width=20,textvariable=self.var_atten_attendance,font=("times new roman",13,"bold"))
      ...
      #  update_btn.grid(row=0,column=1)
       ...
       reset_btn=Button(btn_frame,text="Reset",width=17,command=self.reset_data,font=("times new roman",13,"bold"),bg="blue",fg="white",cursor="hand2")
       ...
       self.AttendanceReportTable=ttk.Treeview(table_frame,column=("id","regd","name","time","date","attendance"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def get_cursor(self,event = ""):
       ...
       self.var_atten_regd.set(rows[1])
